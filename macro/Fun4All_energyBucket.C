...
//R__LOAD_LIBRARY(libcalo_reco.sio)
//R__LOAD_LIBRARY(libg4dst.so)



void Fun4All_energyBucket(const int Nwait = 1, //when to actually graph
	        	  const int should_exit = 1, //whether or not to exit root afterwords, 0 to stay
			  const int is_simfile = false, //If you are using a simulation file like pythia or something, set to true
  ...
  //only needed if you need the vertex or MBD stuff
